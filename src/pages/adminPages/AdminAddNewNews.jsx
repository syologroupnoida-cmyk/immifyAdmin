...
import { AddNewsApi, GetAllNewsApi } from '../../redux/actions/newsAction';
import { FaArrowLeft } from 'react-icons/fa6';
import toast from 'react-hot-toast';

const AdminAddNewBlog = () => {
  const { newsLoading, news } = useSelector((state) => state.newsContainer); // Updated to blogContainer
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(AddNewsApi(title, description, content, banner));
  ...
  return (
    <div className="w-[100%] mx-auto p-6 bg-white rounded-xl shadow-md space-y-6">
      ...
      <h2 className="text-2xl font-bold text-gray-800">Create News here</h2>
